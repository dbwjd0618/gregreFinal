...
<!-- 현위치 검색 -->
<script
	src="${pageContext.request.contextPath}/resources/js/find/careCenterinit.js"></script>
<script>
...
<div class="ftco-blocks-cover-1">
	<div class="site-section-cover overlay"
		...
		style="background-image: url('${pageContext.request.contextPath}/resources/images/find/careCenter.jpg')">
		<div class="container">
				...
				<div class="col-md-5 mt-5 pt-5">
					...
					<p>
						<a href="${pageContext.request.contextPath}/" class="text-white">Home</a> <span
							class="mx-3">/</span> <strong>어린이집 찾기</strong>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-9">
				...
				<div class="row">
					<div class="col-lg-8">
						<h5>
							<strong>어린이집 찾기 </strong>
						</h5>
					</div>
				</div>

				<div class="location-careCenter">
					<span>&nbsp;&nbsp;어린이집 지역별 검색</span>
...
<!-- 위치 검색 -->
<script
	src="${pageContext.request.contextPath}/resources/js/find/careCentersearch.js"></script>
