...
<!-- 현위치 검색 -->
<script
	src="${pageContext.request.contextPath}/resources/js/find/pharmacyinit.js"></script>
<script>
...
<div class="ftco-blocks-cover-1">
	<div class="site-section-cover overlay"
		...
		style="background-image: url('${pageContext.request.contextPath}/resources/images/find/pharmacy.jpg')">
		<div class="container">
				...
				<div class="col-md-5 mt-5 pt-5">
					...
					<p>
						<a href="${pageContext.request.contextPath}/" class="text-white">Home</a> <span
							class="mx-3">/</span> <strong>약국 찾기</strong>
					</p>
				</div>
			</div>
		</div>
