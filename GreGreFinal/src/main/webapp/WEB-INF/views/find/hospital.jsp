...
<!-- 현위치 검색 -->
<script
	src="${pageContext.request.contextPath}/resources/js/find/hospitalinit.js"></script>
<script>
...
<div class="ftco-blocks-cover-1">
	<div class="site-section-cover overlay"
		...
		style="background-image: url('${pageContext.request.contextPath}/resources/images/find/hospital.jpg')">
		<div class="container">
				...
				<div class="col-md-5 mt-5 pt-5">
					...
					<p>
						<a href="index.html" class="text-white">Home</a> <span
							class="mx-3">/</span> <strong>병원 찾기</strong>
					</p>
				</div>
			</div>
		</div>
...
<!-- 위치 검색 -->
<script
	src="${pageContext.request.contextPath}/resources/js/find/hospitalsearch.js"></script>
