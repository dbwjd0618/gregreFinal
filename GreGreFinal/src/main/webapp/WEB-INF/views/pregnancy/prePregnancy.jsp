	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3">
				...
				<ul class="menu">
					<li class="list"><a
						href="${pageContext.request.contextPath }/pregnancy/pregnancy.do">임신정보</a>
						<ul class="items">
							<li><a href="#">임신준비</a></li>
						</ul></li>
					<li class="list"><a
						href="${pageContext.request.contextPath }/pregnancy/calendar.do">월경캘린더</a></li>
			...
			<div class="col-lg-9">
				...
				<div class="com_tab_box">
					<div class="com_tab">
						<ul>
							<li class="ok_01 w33"><a
								href="/cpin/contents/010103010000.jsp"
								id="link_dep4_p1_010103010000"> <span>임신 6개월전</span>
							</a></li>
							<li class=""><a href="/cpin/contents/010103020000.jsp"
								id="link_dep4_p1_010103020000"> <span>임신 3개월전</span>
							</a></li>
							<li class=""><a href="/cpin/contents/010103030000.jsp"
