...
<body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="${pageContext.request.contextPath}/counselorAdmin/login.do"><b>상담사 관리자&nbsp;</b>로그인</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg"><b>관리자</b>님 안녕하세요!</p>
        <p class="login-box-msg">로그인을 해주세요.</p>
        <form action="${pageContext.request.contextPath}/counselorAdmin/login.do" method="post">
