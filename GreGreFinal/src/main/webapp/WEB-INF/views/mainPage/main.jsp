		...
		<div class="row">
			<div class="main-row2">
				<div class="notice-list">
					<h2>공지사항</h2>
					<a href="${pageContext.request.contextPath}/board/postList?boardCode=B1"><img
						src="${pageContext.request.contextPath}/resources/images/index/more.png"
						class="more" alt=""></a>
					<ul>
						<c:forEach items="${idxNotice}" var="post">
							<li><a href="${pageContext.request.contextPath}/board/postView?boardCode=B1&postNo=${post.postNo}">${post.title}</a></li>
						</c:forEach>
					</ul>
				</div>
				...
				<div class="notice-list">
					...
					<ul>
						<c:forEach items="${favList}" var="post">
							<li><a href="${pageContext.request.contextPath}/board/postView?boardCode=${post.boardCode}&postNo=${post.postNo}">${post.title}</a></li>
						</c:forEach>
					</ul>
				</div>
				...
				<div class="col-lg-8 offset-lg-1">
					<div class="product-slider owl-carousel">
						<div class="product-item">
							<div class="pi-pic">
								<img
									src="${pageContext.request.contextPath}/resources/img/products/women-1.jpg"
									alt="">
						...
						<div class="product-item">
							<div class="pi-pic">
								<img
									src="${pageContext.request.contextPath}/resources/img/products/women-2.jpg"
									alt="">
								<div class="icon">
									<img src="https://img.icons8.com/ios/50/000000/hearts.png"
										style="width: 25px;">
						...
						<div class="product-item">
							<div class="pi-pic">
								<img
									src="${pageContext.request.contextPath}/resources/img/products/women-3.jpg"
									alt="">
								<div class="icon">
									<img src="https://img.icons8.com/ios/50/000000/hearts.png"
										style="width: 25px;">
						...
						<div class="product-item">
							<div class="pi-pic">
								<img
									src="${pageContext.request.contextPath}/resources/img/products/women-4.jpg"
									alt="">
								<div class="icon">
									<img src="https://img.icons8.com/ios/50/000000/hearts.png"
										style="width: 25px;">
