                    ...
                    <div class="modal-body">
                        ...
                        <!-- <div class="row">
                            <div class="col-xs-12">
                                ...
                                <input class='allDayNewEvent' id="edit-allDay" type="hidden" checked="checked">
                            </div>
                        </div> -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <label class="col-xs-4" for="edit-title">주기</label>
                                <input class="inputModal" type="number" name="mensesCycle" id="mensesCycle"
                                    required="required" />
                            </div>
                        </div>
                        ...
                        <!-- <div class="row">
                            <div class="col-xs-12">
                                ...
                                <select class="inputModal" type="text" name="edit-type" id="edit-type">
                                    <option value="카테고리1">규칙적</option>
                                    <option value="카테고리2">불규칙적</option>
                                </select>
                            </div>
                        </div> -->
                        <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <label class="checkbox-inline"><input class='filter' id="editName"type="checkbox" value="${m.memberId }"
                                checked>${m.memberId }</label>
                    </div>
                </div>
