...
<script>
	function addOption(t, optPrice, optNm) {
...
<script>
function change(num){
	var x = Number($('[name=count]').val()) ;
	var y;
	if(num =-1) 
		y=1;
	if(x>1)
		y=Number($('[name=count]').val()) + num;
	$('[name=count]').val(y);
}
								...
								<div class="product-details">
									...
									<div class="prd-option">
										...
										<div class="dropdown-wrap select fn-select"
											data-role="dropdown" data-effect="slide" style="z-index: 1;">
											<button type="button" class="btn-sel-option fn-btn">
												옵션을 선택하세요<span class="down-up-icon"></span>
											</button>
											<div class="dropdown-cont fn-cont right share-cont"
												data-width="550" style="width: 550px;" id="dropdown-menu-3"
												aria-hidden="true" aria-owns="dropdown-btn-3">
														...
														<c:forEach items="${optionList }" var="opt" varStatus="vs">
															<li class="item">
																...
																<button class="btn-option"
																	onclick="addOption(this,'${opt.optionPrice}','${opt.optionName} _ ${opt.optionValue }')">${opt.optionName}_${opt.optionValue }</button>
															</li>
														</c:forEach>
													</c:if>
												</ul>
                                            ...
                                            <div class="option-info">
                                                <div class="fleft">
                                                    ...
                                                    <div class="number-count fn-count">
                                                            <div class="quantity">
                                                                <div class="pro-qty"><span class="dec qtybtn" onclick="change(-1)">-</span>
                                                                    <input type="text" name="count" value="1">
                                                                <span class="inc qtybtn" onclick="change(1)">+</span></div>
                                                            </div>
                                                        </div>
                                                </div>
                                                <div class="fright">
									...
									<div class="row">
										<div class="col-lg-6"
											style="padding: 0 5px 0 10px !important;">
										...
										<div class="col-lg-6"
											style="padding: 0 5px 0 10px !important;">
											<a
												href="${pageContext.request.contextPath }/shop/checkOut.do"
									...
									<div class="tab-pane fade" id="tab-3" role="tabpanel">
										<div class="customer-review-option">
											...
											<div class="row">
												<div class="col-lg-12">
													<div
														class="at-rating production-review-feed__header__stars">
														<div>
											...
											<div class="comment-option">
												...
												<div class="co-item row ">
													...
													<div class="avatar-text col-lg-8">
														<p class="at-reply">Lorem ipsum dolor sit amet
															consectetur adipisicing elit. Labore atque alias
															provident reprehenderit ullam, possimus autem non
															obcaecati totam similique, placeat accusantium! Quam
															itaque id nostrum? Velit alias unde quaerat!</p>
														<div class="production-review-item__help">
															<button type="button"
																class="production-review-item__help__btn btn btn-outline-success my-2 my-sm-0">
																도움이 돼요</button>
																...
																<td colspan="6">
																	<div class="fold-content">
																		...
																		<div class="as">
																			...
																			접수해주신 상품문의에 대한 답변드립니다. 주문하신 상품은 어제 출고되었으며, 배송은 1~2일
																			소요 예상됩니다. 감사합니다. 즐거운 하루 보내세요.
																		</div>
																		<p class="reginfo">
							...
							<div class="form-group">
								...
								<div class="at-rating" style="font-size: 30px; color: #FAC451;">
									<label class="rating-input__star " aria-label="별점 1점">
										<input type="radio" value="1"> <i class="fa fa-star-o"></i>
									</label> <label class="rating-input__star" aria-label="별점 2점">
										<input type="radio" value="2"> <i class="fa fa-star-o"></i>
									</label> <label class="rating-input__star" aria-label="별점 3점">
										<input type="radio" value="3"> <i class="fa fa-star-o"></i>
									</label> <label class="rating-input__star" aria-label="별점 4점">
										<input type="radio" value="4"> <i class="fa fa-star-o"></i>
									</label> <label class="rating-input__star" aria-label="별점 5점">
										<input type="radio" value="5"> <i class="fa fa-star-o"></i>
									</label>
